...
public class HighLow {
    public static void main(String[] args) {
        ...
        int[] nums = toArray(in.nextLine().split(" "));
    ...
    private static int[] toArray(String[] arr) {
        int[] rs = new int[arr.length];
        for (int i = 0; i < rs.length; i++) rs[i] = Integer.parseInt(arr[i]);
        return rs;
    }
}
